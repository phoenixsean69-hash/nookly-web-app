                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {approved ? (
                        ...
                        <span className="inline-flex items-center gap-1 rounded-full border border-blue-700 bg-blue-900 px-2.5 py-1 text-xs font-semibold text-amber-700 dark:border-white dark:bg-blue-900/30 dark:text-white">
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-900">
            ...
            <div className="mt-5 rounded-xl bg-gray-50 p-4 text-sm dark:bg-gray-800">
              ...
              <p className="mt-1 text-gray-500 dark:text-gray-400">
                {primaryVehicle
                  ? `${primaryVehicle.make} ${primaryVehicle.model} Â· ${primaryVehicle.registrationNumber}`
            ...
            <div className="mt-6 flex gap-3">
              ...
              >
                ...
                {approving ? "Approvingâ€¦" : "Confirm approval"}
              </button>
            </div>
          </div>
        </div>
