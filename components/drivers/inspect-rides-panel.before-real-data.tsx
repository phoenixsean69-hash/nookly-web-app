...
const statusStyles: Record<RideStatus, string> = {
  active:
    "border-[var(--accent-200)] bg-[var(--accent-50)] text-[var(--accent-700)] dark:border-[var(--accent-800)] dark:bg-[var(--accent-950)]/30 dark:text-[var(--accent-300)]",
  boarding:
...
export function InspectRidesPanel() {
  ...
  return (
    <div className="space-y-5">
      <section className="rounded-2xl border border-[var(--accent-200)] bg-[var(--accent-50)] p-4 dark:border-[var(--accent-900)] dark:bg-[var(--accent-950)]/25">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[var(--accent-500)] text-white">
              <Navigation className="h-5 w-5" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="font-bold">Inspect Rides interface preview</h2>
                <span className="rounded-full bg-white px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-[var(--accent-700)] shadow-sm dark:bg-gray-900 dark:text-[var(--accent-300)]">
                  UI only
                </span>
              </div>
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-2xl border p-4 text-left transition ${
                    selected
                      ? "border-[var(--accent-500)] bg-[var(--accent-50)] shadow-sm dark:bg-[var(--accent-950)]/20"
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                        <CarFront className="h-5 w-5 text-[var(--accent-600)]" />
                      </div>
                    ...
                    {ride.health === "attention" ? (
                      ...
                      <CheckCircle2 className="h-5 w-5 shrink-0 text-[var(--accent-600)]" />
                    )}
                  </div>
                  ...
                  {ride.warning && (
                    <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs font-semibold text-amber-700 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-300">
                      {ride.warning}
                    </div>
                  )}
                </button>
          ...
          <section className="grid gap-5 lg:grid-cols-2">
            <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
              <div className="flex items-start justify-between gap-3">
                ...
                <UserRound className="h-5 w-5 text-[var(--accent-600)]" />
              </div>
    ...
    <div className="relative h-[390px] overflow-hidden bg-gray-100 dark:bg-gray-950">
      ...
      >
        ...
        <polyline
          ...
          fill="none"
          className="stroke-[var(--accent-500)]"
          strokeWidth="8"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        ...
        <circle
          ...
          cy={map.pickup.cy}
          r="13"
          className="fill-white stroke-[var(--accent-600)] dark:fill-gray-900"
          strokeWidth="6"
        />
        <circle
        ...
        <circle
          ...
          className={
            ride.health === "attention"
              ...
              : "fill-[var(--accent-600)] stroke-white"
          }
          strokeWidth="4"
        />
      ...
      <div
        className={`flex h-10 w-10 items-center justify-center rounded-xl ${
          warning
            ...
            : "bg-[var(--accent-50)] text-[var(--accent-600)] dark:bg-[var(--accent-950)]/30 dark:text-[var(--accent-300)]"
        }`}
      >
