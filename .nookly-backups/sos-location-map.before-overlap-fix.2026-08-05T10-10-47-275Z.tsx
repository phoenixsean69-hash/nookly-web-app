...
export function SosLocationMapPreview(props: SosLocationMapBaseProps) {
  return (
    <div className="h-[340px] bg-gray-100 dark:bg-gray-950">
...
export function SosLocationMapModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[140] flex items-center justify-center bg-black/70 p-3 backdrop-blur-sm sm:p-5"
      role="dialog"
      aria-modal="true"
    ...
    >
      <section className="flex max-h-[94vh] w-full max-w-6xl flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="h-[68vh] min-h-[420px] max-h-[680px] bg-gray-100 dark:bg-gray-950">
