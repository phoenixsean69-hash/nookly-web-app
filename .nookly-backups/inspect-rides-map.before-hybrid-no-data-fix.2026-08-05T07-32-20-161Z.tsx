...
function FitInspectionBounds({
  ...
  useEffect(() => {
    ...
    // Fit only once when a different ride is selected.
    // Live API refreshes can update markers without repeatedly moving,
    // zooming, or redrawing the user's current map view.
